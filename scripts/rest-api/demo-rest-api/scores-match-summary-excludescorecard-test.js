...
/**
k6 run -e DURATION=10m,15m,5m -e TARGET=1,1,0 .\scripts\k6\rest-api\scoresapi-match-summary\scores-match-summary-excludescorecard-test.js  -e DATACOUNT=1000
## CLOUD EXECUTION ##
1) k6 login cloud --token *******************
2) k6 cloud -e DURATION=10m,15m,5m -e TARGET=1,1,0 .\scripts\k6\rest-api\scoresapi-match-summary\scores-match-summary-excludescorecard-test.js  -e DATACOUNT=1000
**/
...
export let options = setup_ramp("match-summary");
...
export default function () {
    ...
    console.log(`Response : ${JSON.stringify(matchId)}`);
